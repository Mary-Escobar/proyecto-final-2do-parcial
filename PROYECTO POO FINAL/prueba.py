...
tc= TextColor()
borrarPantalla()
gotoxy(20,1);print(tc.default_red('Descripcion '))
gotoxy(20,1);c = input(tc.default_blue(''))
colorama.init(autoreset=True)

print('\033[31m' + 'some red text')
print('\033[39m')  # and reset to default color
print()
print(f"{Fore.RED}hola{Fore.GREEN} QUE {Fore.YELLOW}","Que haces")
c = input(f"{Fore.RED}Escribe Algo {Fore.BLUE}")
